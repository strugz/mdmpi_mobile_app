            ...
            child: Obx(() {
              if (title == 'Advanced Payment') {
                ...
                if (unassigned.isEmpty && resolvedAccounts.isEmpty) {
                  return const Center(
                      child: Text('No advanced payments found.'));
                }
                ...
                return ListView(
                  ...
                  children: [
                    if (unassigned.isNotEmpty) ...[
                      Text('Unassigned Payments',
                          style: Theme.of(context).textTheme.titleMedium),
                      const SizedBox(height: BSizes.sm),
                      ...unassigned.map((pay) {
                        final client = controller.masterAccountList.firstWhere(
                            (c) => c.id == pay['clientId'],
                        ...
                        return GestureDetector(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              border:
                                  Border.all(color: BCollectionColors.outline),
                              boxShadow: [
                                BoxShadow(
                                    color:
                                        BCollectionColors.ink.withOpacity(0.03),
                                    blurRadius: 4,
                                  ...
                                  children: [
                                    ...
                                    SizedBox(
                                      ...
                                      child: ElevatedButton(
                                        onPressed: () =>
                                            _showPaymentDetailSheet(
                                                context, controller, pay),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                  'Amount: ${BFormatter.formatPesoCurrency(payment['amount'] ?? 0)}',
                  style: Theme.of(context)
                      .textTheme
                      .titleMedium
                ...
                child: Column(
                  children: [
                    ...
                    TextFormField(
                      ...
                      decoration:
                          const InputDecoration(labelText: 'Amount Due'),
                    ...
                    onPressed: () {
                      if (formKey.currentState?.validate() ?? false) {
                        controller.assignInvoiceToPayment(
                          ...
                          amountDue:
                              BFormatter.parseAmount(amountDueController.text),
                          dueDate: dueDateController.text,
                        );
                        Get.back();
                        BLoaders.successSnackBar(
                            title: 'Assigned',
                            message: 'Invoice assigned to payment.');
                      }
                    },
                    child: const Text('Assign'),
                  ),
