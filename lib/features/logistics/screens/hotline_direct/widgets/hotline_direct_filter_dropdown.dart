...
/// Date filter dropdown widget for Hotline Direct requests.
///
/// Displays a dropdown with date filter options (Today, Yesterday, Tomorrow, etc.)
/// and applies the selected filter to the Hotline Direct controller.
class HotlineDirectFilterDropdown extends StatelessWidget {
  const HotlineDirectFilterDropdown({super.key});
