/// DTO for "Item Packed" history entries.
class AirSeaItemPackedHistoryDto {
  final int? historyID;
  ...
  factory AirSeaItemPackedHistoryDto.fromJson(Map<String, dynamic> json) {
    return AirSeaItemPackedHistoryDto(
      ...
      itemPreparedEndAt: json['itemPreparedEndAt'] as String?,
