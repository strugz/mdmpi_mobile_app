...
class SmsController(private val context: Context) {
    ...
    private fun getSmsManager(subId: Int): SmsManager {
        ...
        // SmsManager is only available through getSystemService on API 31+.
        // On older devices (Android 11 and below) it returns null, so fall
        // back to the pre-31 static accessors there.
